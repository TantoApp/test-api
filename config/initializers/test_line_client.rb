...
# apibuilder 0.14.59 app.apibuilder.io/tantoapp/test_line/1.0.0-dev/ruby_client
      ...
      module V1
        ...
        class Client
          ...
          module Constants
            ...
            NAMESPACE = 'tantoapp.test.line.v1' unless defined?(Constants::NAMESPACE)
            USER_AGENT = 'apibuilder 0.14.59 app.apibuilder.io/tantoapp/test_line/1.0.0-dev/ruby_client' unless defined?(Constants::USER_AGENT)
            VERSION = '1.0.0-dev' unless defined?(Constants::VERSION)
            VERSION_MAJOR = 1 unless defined?(VERSION_MAJOR)
          ...
          def test_lines
            @test_lines ||= ::Tantoapp::Test::Line::V1::Clients::TestLines.new(self)
          end
        end
        ...
        module Clients
          ...
          class TestLines
            ...
            def initialize(client)
              @client = HttpClient::Preconditions.assert_class('client', client, ::Tantoapp::Test::Line::V1::Client)
            end
            ...
            def get_by_id(id)
              ...
              r = @client.request("/api/v1/test_lines/#{id}").get
              ::Tantoapp::Test::Line::V1::Models::TestLine.new(r)
            end

            def post(test_line_form)
              (x = test_line_form; x.is_a?(::Tantoapp::Test::Line::V1::Models::TestLineForm) ? x : ::Tantoapp::Test::Line::V1::Models::TestLineForm.new(x))
              r = @client.request("/api/v1/test_lines").with_json(test_line_form.to_json).post
              ::Tantoapp::Test::Line::V1::Models::TestLine.new(r)
            end

            # Deletes the test_line specified via id
            def delete_by_id(id)
              HttpClient::Preconditions.assert_class('id', id, Integer)
              r = @client.request("/api/v1/test_lines/#{id}").delete
              r
            end

            # Updates the test_line specified via id
            def put_by_id(id, test_line_form)
              HttpClient::Preconditions.assert_class('id', id, Integer)
              (x = test_line_form; x.is_a?(::Tantoapp::Test::Line::V1::Models::TestLineForm) ? x : ::Tantoapp::Test::Line::V1::Models::TestLineForm.new(x))
              r = @client.request("/api/v1/test_lines/#{id}").with_json(test_line_form.to_json).put
              ::Tantoapp::Test::Line::V1::Models::TestLine.new(r)
            end
        ...
        module Models
          ...
          class TestLine
            ...
            def initialize(incoming={})
              ...
              @created_at = HttpClient::Preconditions.assert_class('created_at', opts.delete(:created_at), String)
              @updated_at = HttpClient::Preconditions.assert_class('updated_at', opts.delete(:updated_at), String)
            end
            ...
            def copy(incoming={})
              TestLine.new(to_hash.merge(HttpClient::Helper.symbolize_keys(incoming)))
            end
          ...
          class TestLineForm
            ...
            attr_reader :test_id, :description, :status, :active

            def initialize(incoming={})
              opts = HttpClient::Helper.symbolize_keys(incoming)
              HttpClient::Preconditions.require_keys(opts, [:test_id, :description], 'TestLineForm')
              @test_id = HttpClient::Preconditions.assert_class('test_id', opts.delete(:test_id), Integer)
              @description = HttpClient::Preconditions.assert_class('description', opts.delete(:description), String)
              @status = HttpClient::Preconditions.assert_class('status', (x = opts.delete(:status); x.nil? ? 0 : x), Integer)
            ...
            def copy(incoming={})
              TestLineForm.new(to_hash.merge(HttpClient::Helper.symbolize_keys(incoming)))
            end
